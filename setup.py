...
REQUIRED = ["zeep>=3.0.0", "xmlsec>=0.6.1", "typing>=3.6.6"]

EXAMPLES_REQUIRE = ["flask"]

LXML_REQUIRE = ["lxml>=4.1.1"]

TESTS_REQUIREMENTS = ["nose>=1.0", "coverage", "mock", "requests_mock"]
...
setup(
    ...
    extras_require={"examples": EXAMPLES_REQUIRE, "lxml": LXML_REQUIRE},
