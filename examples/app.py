...
def mall_capture():
    ...
    return flask.render_template("mall/captured.html", capture=capture_response)
...
def mall_refund():
    ...
    return flask.render_template("mall/refunded.html", nullify=nullify)
...
def mall_release():
    ...
    return flask.render_template("mall/released.html", release=release)
...
def mall_release_nullification():
    ...
    release = oneclick_mall_service.reverse_nullification(
        buy_order=buy_order, nullify_amount=nullify_amount, commerce_id=commerce_id
    )
    return flask.render_template("mall/reverse_nullify.html", release=release)
...
def mall_remove_user():
    ...
    return flask.render_template("mall/remove.html", remove=remove)
